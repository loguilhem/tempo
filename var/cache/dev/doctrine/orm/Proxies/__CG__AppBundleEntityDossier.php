 ...
 */
class Dossier extends \AppBundle\Entity\Dossier implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Dossier' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Dossier' . "\0" . 'nom', '' . "\0" . 'AppBundle\\Entity\\Dossier' . "\0" . 'numero'];
        }
