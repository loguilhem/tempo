...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\DossierType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\DossierType']) ? $this->services['AppBundle\\Form\\DossierType'] : ($this->services['AppBundle\\Form\\DossierType'] = new \AppBundle\Form\DossierType())) && false ?: '_'};
}, 'AppBundle\\Form\\Recap1Type' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\Recap1Type']) ? $this->services['AppBundle\\Form\\Recap1Type'] : ($this->services['AppBundle\\Form\\Recap1Type'] = new \AppBundle\Form\Recap1Type())) && false ?: '_'};
}, 'AppBundle\\Form\\Recap2Type' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\Recap2Type']) ? $this->services['AppBundle\\Form\\Recap2Type'] : ($this->services['AppBundle\\Form\\Recap2Type'] = new \AppBundle\Form\Recap2Type())) && false ?: '_'};
}, 'AppBundle\\Form\\TacheType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\TacheType']) ? $this->services['AppBundle\\Form\\TacheType'] : ($this->services['AppBundle\\Form\\TacheType'] = new \AppBundle\Form\TacheType())) && false ?: '_'};
}, 'AppBundle\\Form\\TempsType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\TempsType']) ? $this->services['AppBundle\\Form\\TempsType'] : ($this->services['AppBundle\\Form\\TempsType'] = new \AppBundle\Form\TempsType())) && false ?: '_'};
